/* jQuery Selector de Fileds i Checks per iPad i altres cacharrus Apple */
...
/* Si els inputs tenent icona (li: before) focus amb click */
	$li_input = jQuery( "form input:text" ).parent("li");
	//window.console&&console.log($li_input);
	jQuery($li_input).each(function(index) {
		jQuery(this).on("click", function(){
			//window.console&&console.log(this);
			jQuery(this).children('input:text').focus();
		});
	});
