...
<div class="metabox-holder no-widget" id="posts-box">
    <div class="postbox closed">
        ...
        <div class="inside">
          ...
          <div class="postbox closed">
            <div class="handlediv" title="Click to toggle."><br></div>
            <h3 class="hndle"><i class="icon-list"></i>&nbsp;&nbsp;
            <?php if( qtrans_getLanguage() == 'es' ){	?>
            ...
            <div class="inside">
            	...
            	<h4>
                  ...
                  <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_01a.gif" />' ?>
                  <br /><br />
                  <p>
					<?php if( qtrans_getLanguage() == 'es' ){	?>
                  ...
                  <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_01b.gif" />' ?>
                  <br />
                  <p>
					<?php if( qtrans_getLanguage() == 'es' ){	?>
					...
					<?php echo '<img class="help_img fl" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_01c.gif" />' ?>
                  <br />
                  <p class="clear">
                  	<br />
					<?php if( qtrans_getLanguage() == 'es' ){	?>
					...
					<?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_01d.gif" />' ?>
                  <p>
                  	<br />
					<?php if( qtrans_getLanguage() == 'es' ){	?>
                  ...
                  <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_01e.gif" />' ?><br />
                  ...
                  <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_01f.gif" />' ?><br />
                  <p>
					<?php if( qtrans_getLanguage() == 'es' ){	?>
                  ...
                  <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_01g.gif" />' ?><br />
            	<span class="closer"><i class="icon-remove-circle"></i>
            	<?php if( qtrans_getLanguage() == 'es' ){	?>CERRAR "<em>POSTS > Todas las Entradas</em>"
        ...
        <div class="postbox closed">
            <div class="handlediv" title="Click to toggle."><br></div>
            <h3 class="hndle"><i class="icon-edit"></i>&nbsp;&nbsp;
                <?php if( qtrans_getLanguage() == 'es' ){	?>
            ...
            <div class="inside">
                ...
                <div class="postbox closed">
                    <div class="handlediv" title="Click to toggle."><br></div>
                    <h3 class="hndle"><i class="icon-chevron-right"></i>&nbsp;
                        <?php if( qtrans_getLanguage() == 'es' ){	?>
                    ...
                    <div class="inside">
                        ...
                        <?php }else{ //english ?>
                            Title
                        <?php } ?>
                        <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_02a.gif" />' ?>
                        </p>
                        <p><br />
                        <?php if( qtrans_getLanguage() == 'es' ){	?>
                        ...
                        <?php }else{ //english ?>
                            Edit permalink
                        <?php } ?>
                        <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_02b.gif" />' ?>
                        </p>
                        <p><b>
                        <?php if( qtrans_getLanguage() == 'es' ){	?>
                        ...
                        <span class="closer"><i class="icon-remove-circle"></i> 
							<?php if( qtrans_getLanguage() == 'es' ){	?>CERRAR "<em>POSTS > Añadir (Edicion de la Noticia) > Título</em>"
                ...
                <div class="postbox closed">
                    ...
                    <div class="inside">
    					...
    					<?php include_once(get_stylesheet_directory() . '/custom_admin/help_docs/help_posts_wysiwyg.php');?>
                    </div><!-- /inside -->
                </div> <!-- WYSIWYG -->
                <!-- Extracte -->
                <div class="postbox closed">
                    ...
                    <div class="inside">
                        ...
                        <p><br />
                            ...
                            <?php }else{ //english ?>
                                Excerpt Description
                            <?php } ?>
                            <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() . '/custom_admin/help_docs/images/02posts_02c.gif" />' ?>
                      	</p>
                        <span class="closer"><i class="icon-remove-circle"></i>
							<?php if( qtrans_getLanguage() == 'es' ){	?>CERRAR "<em>POSTS > Añadir (Edicion de la Noticia) > Extracto</em>"
                    ...
                    <div class="inside">
                        ...
                        <p><br />
							<?php if( qtrans_getLanguage() == 'es' ){	?>
                                ...
                                <p><a href="https://www.google.es/imghp?as_st=y&tbm=isch&as_q=&as_epq=&as_oq=&as_eq=&cr=countryES&as_sitesearch=&safe=images&tbs=ctr:countryES,isz:lt,islt:svga,iar:w" target="_blank"> BUSCADOR DE IMÁGENES DE GOOGLE </a> <i class="icon-external-link"></i></p>
                            ...
                            <?php }elseif( qtrans_getLanguage() == 'ca' ){ ?>
                                ...
                                <p><a href="https://www.google.es/imghp?as_st=y&tbm=isch&as_q=&as_epq=&as_oq=&as_eq=&cr=countryES&as_sitesearch=&safe=images&tbs=ctr:countryES,isz:lt,islt:svga,iar:w" target="_blank"> BUSCADOR D'IMATGES DE GOOGLE </a> <i class="icon-external-link"></i></p>
                            ...
                            <?php }else{ //english ?>
                                Excerpt Description
                            <?php } ?>
                            <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_02d.gif" />' ?>
                      	</p>
                        ...
                        <p><br />
							<?php if( qtrans_getLanguage() == 'es' ){	?>
                                ...
                                <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_02e.gif" />' ?>
                                </p>
                                ...
                                <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_02f.gif" />' ?>
                                </p>
                                ...
                                <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_02f2.gif" />' ?>
                                </p>
                                <!-- Avís Mida Imatges --> 
                            	...
                            	<?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_02g.gif" />' ?>
                                ...
                                <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_02h.gif" />' ?>
                            <?php }elseif( qtrans_getLanguage() == 'ca' ){ ?>
            ...
            <!-- Avís Mida Imatges --> 
                    	...
                    	<br />
                        <span class="closer"><i class="icon-remove-circle"></i>
							<?php if( qtrans_getLanguage() == 'es' ){	?>CERRAR "<em>POSTS > Añadir (Edicion de la Noticia) > Imagen Destacada</em>"
                ...
                <div class="postbox closed">
                    ...
                    <div class="inside">
						...
						<?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_02i.gif" />' ?>
                        <p>
                        <?php if( qtrans_getLanguage() == 'es' ){	?>
                        ...
                        <span class="closer"><i class="icon-remove-circle"></i>
                            <?php if( qtrans_getLanguage() == 'es' ){	?>CERRAR "<em>POSTS > Añadir (Edicion de la Noticia) > Categoria</em>"
                ...
                <div class="postbox closed">
                    ...
                    <div class="inside">
						...
						<?php if( qtrans_getLanguage() == 'es' ){	?>
                            ...
                            <li><strong>Listado de etiquetas seleccionadas para esta noticia</strong>. Podemos eliminarlas pulsando sobre <i class="icon-remove-sign"></i>.</li>
                        <?php }elseif( qtrans_getLanguage() == 'ca' ){ ?>
                            ...
                            <li><strong>Llistat d'etiquetes seleccionades per aquesta notícia</strong>. Podem eliminar-les prement sobre <i class="icon-remove-sign"></i>.</li>
                        <?php }else{ //english ?>
                            <li></li>
                        <?php } ?>
                        </ol>
						<?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_02j.gif" />' ?>
                        <p>
                        <?php if( qtrans_getLanguage() == 'es' ){	?>
                        ...
                        <span class="closer"><i class="icon-remove-circle"></i>
							<?php if( qtrans_getLanguage() == 'es' ){	?>CERRAR "<em>POSTS > Añadir (Edicion de la Noticia) > Etiquetas</em>"
                ...
                <div class="postbox closed">
                    ...
                    <div class="inside">
						...
						<?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_02k.gif" />' ?><br />
						<?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_02k2.gif" />' ?><br /><br />
                        <p>
                        <?php if( qtrans_getLanguage() == 'es' ){	?>
						...
						<?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_02l.gif" />' ?><br /><br />
                        <p>
                        <?php if( qtrans_getLanguage() == 'es' ){	?>
						...
						<?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_02m.gif" />' ?><br /><br />
                        <p>
                        <?php if( qtrans_getLanguage() == 'es' ){	?>
						...
						<?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_02n.gif" />' ?><br />
                        <span class="closer"><i class="icon-remove-circle"></i>
							<?php if( qtrans_getLanguage() == 'es' ){	?>CERRAR "<em>POSTS > Añadir (Edicion de la Noticia) > Opcions de Publicació</em>"
                ...
                <span class="closer"><i class="icon-remove-circle"></i>
					<?php if( qtrans_getLanguage() == 'es' ){	?>CERRAR "<em>POSTS > Añadir (Edicion de la Noticia)</em>"
        ...
        <div class="postbox closed">
            <div class="handlediv" title="Click to toggle."><br></div>
            <h3 class="hndle"><i class="icon-sitemap"></i>&nbsp;&nbsp;
            <?php if( qtrans_getLanguage() == 'es' ){	?>
                Categorías
            <?php }elseif( qtrans_getLanguage() == 'ca' ){ ?>
                Categories
            ...
            <div class="inside">
                ...
                <div class="postbox closed">
                    ...
                    <div class="inside">
                        ...
                        <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_03a.gif" />' ?>
                        <ol>
                        <?php if( qtrans_getLanguage() == 'es' ){	?>
                            ...
                            Este servicio funciona gracias a Font-Awesome, cuyo listado de iconos disponible se puede consultar <a href="http://fortawesome.github.io/Font-Awesome/3.2.1/icons/" target="_blank"><strong>AQUÍ</strong></a> <i class="icon-external-link"></i>.<br />
                            Una vez elijamos el icono de la lista, introduciremos el código correspondiente (por ejemplo <em>icon-shield</em> = <i class="icon-shield"></i>).  Por defecto nos aparecerá el icono <em>icon-bookmark</em> ( <i class="icon-bookmark"></i> ).
                          </li>
						...
						<?php }elseif( qtrans_getLanguage() == 'ca' ){ ?>
                            ...
                            Aquest servei funciona gràcies a Font-Awesome, i el llistat d'icones disponibles es pot consultar <a href="http://fortawesome.github.io/Font-Awesome/3.2.1/icons/" target="_blank"><strong>AQUÍ</strong></a> <i class="icon-external-link"></i>.<br />
                            Un cop triem la icona de la llista, introduirem el codi corresponent (per exemple <em>icon-shield</em> = <i class="icon-shield"></i>).  Per defecte ens apareixerà la icona <em>icon-bookmark</em> ( <i class="icon-bookmark"></i> ).
                          </li>
                        ...
                        <br />
                        <span class="closer"><i class="icon-remove-circle"></i>
                            <?php if( qtrans_getLanguage() == 'es' ){	?>CERRAR "<em>POSTS > Categoría > Nueva Categoría</em>"
                ...
                <div class="postbox closed">
                    ...
                    <div class="inside">
                        ...
                        <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_03b.gif" />' ?>
                        <ol>
                        <?php if( qtrans_getLanguage() == 'es' ){	?>
                        	...
                        	<?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_03c.gif" />' ?>
                            	<ul>
                                    ...
                                    <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_03d.gif" />' ?></li>
                                </ul>
                            </li>
                            ...
                            <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_03e.gif" />' ?>
                            </li>
                            ...
                            <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_03f.gif" />' ?>
                            </li>
                 	 	<?php }elseif( qtrans_getLanguage() == 'ca' ){ ?>
                        ...
                        <span class="closer"><i class="icon-remove-circle"></i>
                            <?php if( qtrans_getLanguage() == 'es' ){	?>CERRAR "<em>POSTS > Categoría > Gestionar Categorías</em>"
                ...
                <br />
                <span class="closer"><i class="icon-remove-circle"></i>
                    <?php if( qtrans_getLanguage() == 'es' ){	?>CERRAR "<em>POSTS > Categoría</em>"
        ...
        <!-- Etiquetes -->
          <div class="postbox closed">
            <div class="handlediv" title="Click to toggle."><br></div>
            <h3 class="hndle"><i class="icon-tag"></i>&nbsp;&nbsp;
            <?php if( qtrans_getLanguage() == 'es' ){	?>
                Etiquetas
            <?php }elseif( qtrans_getLanguage() == 'ca' ){ ?>
                Etiquetes
            ...
            <div class="inside">
                ...
                <div class="postbox closed">
                    ...
                    <div class="inside">
                        ...
                        <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_04a.gif" />' ?>
                        <ol>
                        <?php if( qtrans_getLanguage() == 'es' ){	?>
                            <li><strong>Nombre (Idioma)</strong><br />
                        ...
                        <br />
                        <span class="closer"><i class="icon-remove-circle"></i>
                            <?php if( qtrans_getLanguage() == 'es' ){	?>CERRAR "<em>POSTS > Etiquetas > Nueva Etiqueta</em>"
                ...
                <div class="postbox closed">
                    ...
                    <div class="inside">
                        ...
                        <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_04b.gif" />' ?>
                        <ol>
                        <?php if( qtrans_getLanguage() == 'es' ){	?>
                            <li><strong>Gestión Individualizada</strong><br />
                        	...
                        	<?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_04c.gif" />' ?>
                            	<ul>
                                	<li><strong>EDITAR</strong><br />
                                    ...
                                    <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_04d.gif" />' ?></li>
                                </ul>
                            </li>
                            <li><strong>Gestión en Grupo</strong><br />
                            ...
                            <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_04e.gif" />' ?><br />
                        ...
                        <span class="closer"><i class="icon-remove-circle"></i>
                            <?php if( qtrans_getLanguage() == 'es' ){	?>CERRAR "<em>POSTS > Etiquetas > Gestionar Etiquetas</em>"
                ...
                <br />
                <span class="closer"><i class="icon-remove-circle"></i>
                    <?php if( qtrans_getLanguage() == 'es' ){	?>CERRAR "<em>POSTS > Etiquetas</em>"
        ...
        <!-- Anatomia del Post -->
          <div class="postbox closed">
            <div class="handlediv" title="Click to toggle."><br></div>
            <h3 class="hndle"><i class="icon-table"></i>&nbsp;&nbsp;
            <?php if( qtrans_getLanguage() == 'es' ){	?>
            ...
            <div class="inside">
            	...
            	<h4>
                  ...
                  <ol>
                    ...
                    <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_00a.gif" />' ?>
                    <br />
                    <span class="closer"><i class="icon-remove-circle"></i>
						<?php if( qtrans_getLanguage() == 'es' ){	?>CERRAR "<em>POSTS > Partes de la Noticia</em>"
        ...
        <!-- Notícies Destacades -->
          <div class="postbox closed">
            <div class="handlediv" title="Click to toggle."><br></div>
            <h3 class="hndle"><i class="icon-fire"></i>&nbsp;&nbsp;
            <?php if( qtrans_getLanguage() == 'es' ){	?>
                Noticias Destacadas
            <?php }elseif( qtrans_getLanguage() == 'ca' ){ ?>
                Noticíes Destacades
            ...
            <div class="inside">
            	...
            	<h4>
                  ...
                  <p>
                    ...
                    <?php echo '<br /><img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_00b.gif" />' ?><br /><br />
					<?php if( qtrans_getLanguage() == 'es' ){	?>
                    ...
                    <?php }else{ //english ?>
                        Intro sticky
                    <?php } ?>
                    <?php echo '<br /><img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_00c.gif" />' ?><br /></p>
                    <?php if( qtrans_getLanguage() == 'es' ){	?>
                    ...
                    <?php }else{ //english ?>
                        Intro sticky
                    <?php } ?>
                    <?php echo '<br /><img class="help_img" src="' . get_stylesheet_directory_uri() .'/custom_admin/help_docs/images/02posts_00d.gif" />' ?><br /><br /></p>
                    <?php if( qtrans_getLanguage() == 'es' ){	?>
                    ...
                    <br />
                    <span class="closer"><i class="icon-remove-circle"></i>
						<?php if( qtrans_getLanguage() == 'es' ){	?>CERRAR "<em>POSTS > Noticias Destacadas</em>"
        ...
        <!-- Diferència entre Posts i Pàgines -->
          <div class="postbox closed">
            <div class="handlediv" title="Click to toggle."><br></div>
            <h3 class="hndle"><i class="icon-file-text"></i>&nbsp;&nbsp;
            <?php if( qtrans_getLanguage() == 'es' ){	?>
            ...
            <div class="inside">
              ...
              <p>
                ...
                <span class="closer"><i class="icon-remove-circle"></i>
                    <?php if( qtrans_getLanguage() == 'es' ){	?>CERRAR "<em>POSTS > Diferencia entre Posts y Páginas</em>"
      	...
      	<span class="closer"><i class="icon-remove-circle"></i>
			<?php if( qtrans_getLanguage() == 'es' ){	?>CERRAR "<em>POSTS</em>"
