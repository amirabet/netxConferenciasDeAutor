...
?>
                        ...
                        <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() . '/custom_admin/help_docs/images/02posts_02_wys_a.gif" />' ?><br /><br />
                        <!-- WYSIWYG > Idioma -->
                        <div class="postbox closed">
                            <div class="handlediv" title="Click to toggle."><br></div>
                            <h3 class="hndle"><i class="icon-caret-right"></i>&nbsp;
                                <?php if( qtrans_getLanguage() == 'es' ){	?>
                                    Selector de Idioma
                                <?php }elseif( qtrans_getLanguage() == 'ca' ){ ?>
                                    Selector d'Idioma
                            ...
                            <div class="inside">
                                ...
                                <span class="closer"><i class="icon-remove-circle"></i>
									<?php if( qtrans_getLanguage() == 'es' ){	?>CERRAR  "<em>POSTS > Añadir (Edición de la Noticia) > Editor de Contenidos > Selección de Idioma</em>"
                        ...
                        <div class="postbox closed">
                            ...
                            <div class="inside">
                                ...
                                <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() . '/custom_admin/help_docs/images/02posts_02_wys_a2.gif" />' ?><br />
                            	<span class="closer"><i class="icon-remove-circle"></i>
									<?php if( qtrans_getLanguage() == 'es' ){	?>CERRAR "<em>POSTS > Añadir (Edición de la Noticia) > Editor de Contenidos > Selector de Edición</em>"
                        ...
                        <div class="postbox closed">
                            ...
                            <div class="inside">
                                ...
                                <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() . '/custom_admin/help_docs/images/02posts_02_wys_b.gif" />' ?><br />
                                <ol>
                                	<?php if( qtrans_getLanguage() == 'es' ){	?>
                                ...
                                <ol>
                                	<?php if( qtrans_getLanguage() == 'es' ){	?>
                                        ...
                                        <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() . '/custom_admin/help_docs/images/02posts_02_wys_c2.gif" />' ?>
                                        </li>
								...
								<?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() . '/custom_admin/help_docs/images/02posts_02_wys_c.gif" />' ?>
                                <br />
                                <p>
                                	<?php if( qtrans_getLanguage() == 'es' ){	?>
                                ...
                                <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() . '/custom_admin/help_docs/images/02posts_02_wys_d.gif" />' ?><br /><br />
                                <h4>
                                	<?php if( qtrans_getLanguage() == 'es' ){	?>
                                ...
                                <p>
                                	<?php if( qtrans_getLanguage() == 'es' ){	?>
                                        ...
                                        <i class="icon-ban-circle"></i> <strong>Elimina la Imagen</strong>.<br />
                                        <i class="icon-picture"></i> <strong>Vuelve a Editar los ajustes de la Imagen</strong>.
                                    <?php }elseif( qtrans_getLanguage() == 'ca' ){ ?>
										Un cop inserida la imatge al post,  podem fer-hi clic i ens apareixeran 2 símbols:<br />
                                        <i class="icon-ban-circle"></i> <strong>Elimina la Imatge</strong>.<br />
                                        <i class="icon-picture"></i> <strong>Torna a editar els ajustos d'Imatge</strong>.                                    
									<?php }else{ //english ?>
                                        Excerpt Description
                                    <?php } ?>
                                </p>
                                <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() . '/custom_admin/help_docs/images/02posts_02_wys_e.gif" />' ?><br /><br />
                                <!-- Crear GALERIA -->
                                <div class="postbox closed">
                                    <div class="handlediv" title="Click to toggle."><br></div>
                                    <h3 class="hndle"><i class="icon-angle-right"></i>&nbsp;
                                        <?php if( qtrans_getLanguage() == 'es' ){	?>
                                    ...
                                    <div class="inside">
                                        ...
                                        <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() . '/custom_admin/help_docs/images/02posts_02_wys_f.gif" />' ?><br />
                                        <p>
                                            <?php if( qtrans_getLanguage() == 'es' ){	?>
                                        ...
                                        <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() . '/custom_admin/help_docs/images/02posts_02_wys_f2.gif" />' ?><br />
                                        <p>
                                            <?php if( qtrans_getLanguage() == 'es' ){	?>
                                        ...
                                        <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() . '/custom_admin/help_docs/images/02posts_02_wys_g.gif" />' ?><br />
                           				<span class="closer"><i class="icon-remove-circle"></i>
											<?php if( qtrans_getLanguage() == 'es' ){	?>CERRAR "<em>POSTS > Añadir (Edición de la Noticia) > Editor de Contenidos > Insertar Media > Crear Galería</em>"
                        ...
                        <div class="postbox closed">
                            ...
                            <div class="inside">
                                ...
                                <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() . '/custom_admin/help_docs/images/02posts_02_wys_h.gif" />' ?>
                                <ol>
                                	<?php if( qtrans_getLanguage() == 'es' ){	?>
                                   ...
                                   <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() . '/custom_admin/help_docs/images/02posts_02_wys_i.gif" />' ?>
                                       <ul>
                            	...
                            	<span class="closer"><i class="icon-remove-circle"></i>
									<?php if( qtrans_getLanguage() == 'es' ){	?>CERRAR "<em>POSTS > Añadir (Edición de la Noticia) > Editor de Contenidos > Barra de Edición 1</em>"
                        ...
                        <div class="postbox closed">
                            ...
                            <div class="inside">
                              ...
                              <div class="msg_updated">
                                	<p>
                                    <?php if( qtrans_getLanguage() == 'es' ){	?>
                                       <strong>NOTA</strong>: Para abrir la Barra de Edición2 debemos pulsar el botón <?php echo '<img src="' . get_stylesheet_directory_uri() . '/custom_admin/help_docs/images/02posts_02_wys_j.gif" />' ?> situado en la <strong><a href="#help_posts_new_wysiwyg_bar1">Barra de Edición 1</a></strong>
                                    <?php }elseif( qtrans_getLanguage() == 'ca' ){ ?>
                                       <strong>NOTA</strong>: Per obrir la Barra d'Edició 2 hem de prémer el botó <?php echo '<img src="' . get_stylesheet_directory_uri() . '/custom_admin/help_docs/images/02posts_02_wys_j.gif" />' ?> situat a la <strong><a href="#help_posts_new_wysiwyg_bar1">Barra d'Edició 1</a></strong>
                                    <?php }else{ //english ?>
                                        Warning Bar2
                                    <?php } ?>
                                    </p>
                                ...
                                <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() . '/custom_admin/help_docs/images/02posts_02_wys_k.gif" />' ?>
                                <ol>
                                	<?php if( qtrans_getLanguage() == 'es' ){	?>
                                  	<li>Estilos<br />
                                    ...
                                    <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() . '/custom_admin/help_docs/images/02posts_02_wys_l.gif" />' ?>
                                    </li>
									...
									<?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() . '/custom_admin/help_docs/images/02posts_02_wys_m.gif" />' ?>
                                    <br />
									...
									<?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() . '/custom_admin/help_docs/images/02posts_02_wys_n.gif" />' ?>
                                    </li>
                                    ...
                                    Abre un menú con 4 pestañas:
                                    	<ul>
                                            ...
                                            <?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() . '/custom_admin/help_docs/images/02posts_02_wys_o.gif" />' ?>
                                            </li>
                                ...
                                <span class="closer"><i class="icon-remove-circle"></i>
									<?php if( qtrans_getLanguage() == 'es' ){	?>CERRAR "<em>POSTS > Añadir (Edición de la Noticia) > Editor de Contenidos > Barra de Edición 2</em>"
                        ...
                        <div class="postbox closed">
                            ...
                            <div class="inside">
								...
								<?php echo '<img class="help_img" src="' . get_stylesheet_directory_uri() . '/custom_admin/help_docs/images/02posts_02_wys_p.gif" />' ?>
                                <p><br />
                                    <?php if( qtrans_getLanguage() == 'es' ){	?>
                                        <b>Ruta</b><br />
                                ...
                                <p>
                                    <?php if( qtrans_getLanguage() == 'es' ){	?>
                                        Por ejemplo, dentro de un párrafo podemos tener un enlace con una imagen, cuya ruta sería:<br />
                                        <em><strong>p</strong> &raquo; <strong>a</strong> &raquo; <strong>img</strong></em>.<br />
                                        <strong><a href="http://www.w3schools.com/tags/default.asp" target="_blank">Consulta aquí el listado de etiquetas web</a></strong> <i class="icon-external-link"></i>.
                                    <?php }elseif( qtrans_getLanguage() == 'ca' ){ ?>
                                    	Per exemple, dins d'un paràgraf podem tenir un enllaç amb una imatge, i el seu camí seria:<br />
                                        <em><strong>p</strong> &raquo; <strong>a</strong> &raquo; <strong>img</strong></em>.<br />
                                        <strong><a href="http://www.w3schools.com/tags/default.asp" target="_blank">Consulteu aquí el llistat d'etiquetes web</a></strong> <i class="icon-external-link"></i>.
                                    <?php }else{ //english ?>
                                        Excerpt Description
                                    <?php } ?>
                                </p>
                                ...
                                <span class="closer"><i class="icon-remove-circle"></i>
									<?php if( qtrans_getLanguage() == 'es' ){	?>CERRAR "<em>POSTS > Añadir (Edición de la Noticia) > Editor de Contenidos > Información del Pie</em>"
                        ...
                        <div class="postbox closed">
                            ...
                            <div class="inside">
                                ...
                                <span class="closer"><i class="icon-remove-circle"></i>
									<?php if( qtrans_getLanguage() == 'es' ){	?>CERRAR "<em>POSTS > Añadir (Edición de la Noticia) > Editor de Contenidos > Ventana de Edición</em>"
                        ...
                        <span class="closer"><i class="icon-remove-circle"></i>
							<?php if( qtrans_getLanguage() == 'es' ){	?>CERRAR "<em>POSTS > Añadir (Edición de la Noticia) > Editor de Contenidos</em>"
